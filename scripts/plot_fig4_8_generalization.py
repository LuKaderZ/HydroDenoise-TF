"""图4-8: DCAMF-Net 泛化性能评估 (ShipsEar 三个测试集, SI-SNRi + SDRi)"""
import numpy as np
...
plt.tight_layout()
fig.savefig(FIG_DIR / 'fig4-8_DCAMF_Net_ShipsEar.pdf', dpi=300, bbox_inches='tight')
fig.savefig(FIG_DIR / 'fig4-8_DCAMF_Net_ShipsEar.png', dpi=300, bbox_inches='tight')
plt.show()
print('图4-8 已保存')
