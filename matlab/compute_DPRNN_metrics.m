...
denoisedDir = fullfile(projectRoot, 'experiments', 'dprnn', 'estimates', 'tt_test1');
...
denoisedDir = fullfile(projectRoot, 'experiments', 'dprnn', 'estimates', 'tt_DeepShip');
